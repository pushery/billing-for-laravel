...
return [
    ...
    'subscription' => [
        ...
        'cancel_confirm_question' => 'Vuoi davvero disdire il tuo abbonamento?',
        'cancel_confirm' => 'Sì, disdici',
        'cancel_abort' => 'Mantienilo',
    ...
    'usage' => [
        ...
        'forecast' => 'A circa :rate :unit al giorno, ti basta fino al :date.',
    ...
    'usage_history' => [
        ...
        'reversed' => 'annullato',
        'movements_heading' => 'Tutti i movimenti',
        'movement_spent' => ':units :meter usati',
        'movement_credited' => ':units :meter aggiunti',
    ],
