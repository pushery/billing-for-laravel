...
return [
    ...
    'subscription' => [
        ...
        'cancel_confirm_question' => 'Queres mesmo cancelar a tua subscrição?',
    ...
    // Toasts transmitidos. Uma linha cada: um toast lê-se de passagem, ao lado do e-mail que o explica.
    'toast' => [
