...
return [
    ...
    'cancel_survey' => [
        ...
        'no_reason' => 'Prefiero no decirlo',
        'detail_label' => 'Cuéntanos más',
        'detail_placeholder' => '¿Qué te hizo cancelar?',
        'detail_required' => 'Añade un detalle para «Otro».',
        'reason' => [
            'too_expensive' => 'Es demasiado caro',
            'missing_features' => 'Faltan funciones que necesito',
            'not_using_enough' => 'No lo uso lo suficiente',
            'switched_provider' => 'Me cambié a otro proveedor',
    ...
    'subscription' => [
        ...
        'cancel_confirm_question' => '¿Seguro que quieres cancelar tu suscripción?',
        'cancel_confirm' => 'Sí, cancelar',
        'cancel_abort' => 'Mantenerla',
    ...
    // Toasts emitidos. Una línea cada uno: un toast se lee de pasada, junto al correo que lo explica.
    'toast' => [
        'payment_failed' => 'No hemos podido procesar tu pago. Actualiza tus datos de pago.',
        'subscription_activated' => 'Tu suscripción está activa: todo lo que incluye está disponible.',
        'dismiss' => 'Descartar',
    ],
