 ...
 * @method static void assertNotCanceled(Model $owner, ?MerchantScope $merchant = null)
 * @method static void assertNotResumed(Model $owner, ?MerchantScope $merchant = null)
 * @method static void assertNotCanceledNow(Model $owner, ?MerchantScope $merchant = null)
