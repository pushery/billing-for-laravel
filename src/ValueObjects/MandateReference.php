...
/**
 * A reference to a stored payment mandate/token that can be charged later (a Mollie mandate, a
 * Stripe payment method, an Adyen recurring detail). The `reusable` flag records whether it may be
